"""
Django settings for faizal181071 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-qh^4%sr@3$lq#gnh1($%a!a!du31c@_&2$asl1w5xm-@q8n7nb')
...
ROOT_URLCONF = 'faizal181071.urls'
...
WSGI_APPLICATION = 'faizal181071.wsgi.application'
